...
export const LOG_EVENTS = {
  ...
  WORKER_BATCH_APPLIED: 'worker.batch.applied',
  WORKER_BATCH_FAILED: 'worker.batch.failed',
...
export const MODULE_LOG_EVENT_POLICY = {
  ...
  workers: { success: LOG_EVENTS.WORKER_BATCH_APPLIED, failure: LOG_EVENTS.WORKER_BATCH_FAILED },
